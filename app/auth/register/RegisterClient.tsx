    ...
    <div className="bg-dots-gold flex min-h-screen items-center justify-center px-6 pt-[68px]">
      <div className="w-full max-w-md animate-fade-up">
        ...
        >
          ...
          <div>
            <label htmlFor="reg-name" className="mb-2 block text-[10px] font-semibold uppercase tracking-[2px] text-cream-800/40">
              Full Name *
            </label>
            <input
              id="reg-name"
          ...
          <div>
            <label htmlFor="reg-email" className="mb-2 block text-[10px] font-semibold uppercase tracking-[2px] text-cream-800/40">
              Email *
            </label>
            <input
              id="reg-email"
          ...
          <div>
            <label htmlFor="reg-password" className="mb-2 block text-[10px] font-semibold uppercase tracking-[2px] text-cream-800/40">
              Password *
            </label>
            <input
              id="reg-password"
          ...
          <div>
            <label htmlFor="reg-phone" className="mb-2 block text-[10px] font-semibold uppercase tracking-[2px] text-cream-800/40">
              Phone (optional)
            </label>
            <input
              id="reg-phone"
