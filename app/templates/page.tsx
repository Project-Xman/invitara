...
export default function TemplatesPage() {
  ...
  // Set of template IDs the user already owns
  ...
  const handleSelect = async (t: any) => {
    ...
    // Free or already owned → go straight to editor
    ...
    // Paid template not owned → purchase flow
    setBuyingId(t.id);
    try {
      ...
      // Purchase complete — open in editor
      router.push(`/editor?template=${t.id}`);
    } catch (err: any) {
