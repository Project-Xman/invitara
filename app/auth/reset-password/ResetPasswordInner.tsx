      ...
      <div className="w-full max-w-md animate-fade-up">
        <div className="rounded-2xl border border-gold-200/15 bg-white p-8 shadow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="reset-password" className="mb-1.5 block text-xs font-semibold tracking-wide opacity-50">
                New Password
              </label>
              <input
                id="reset-password"
            ...
            <div>
              <label htmlFor="reset-confirm" className="mb-1.5 block text-xs font-semibold tracking-wide opacity-50">
